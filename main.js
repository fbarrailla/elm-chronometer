...
var _user$project$Main$pad = function (number) {
		...
		switch (_p0.ctor) {
			...
			case 'Stop':
				var diff = A2(
					...
					_elm_lang$core$Date$fromTime(82800000),
					model.diff);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							started: false,
							suspended: _elm_lang$core$Basics$round(
								_elm_lang$core$Date$toTime(diff)),
							startTS: 0
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Reset':
				return {
					ctor: '_Tuple2',
					_0: {startTS: 0, started: false, suspended: 0, diff: _elm_lang$core$Maybe$Nothing},
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Tick':
				var _p1 = _p0._0;
				var startTS = _elm_lang$core$Native_Utils.eq(model.startTS, 0) ? (_elm_lang$core$Basics$round(_p1) - model.suspended) : model.startTS;
				var diff = _elm_lang$core$Date$fromTime(
					_p1 - _elm_lang$core$Basics$toFloat(startTS));
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							startTS: startTS,
							diff: _elm_lang$core$Maybe$Just(diff)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
...
var _user$project$Main$model = {startTS: 0, started: false, suspended: 0, diff: _elm_lang$core$Maybe$Nothing};
var _user$project$Main$init = {ctor: '_Tuple2', _0: _user$project$Main$model, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {startTS: a, started: b, suspended: c, diff: d};
	});
...
var _user$project$Main$onKeyPress = F2(
	function (model, keyCode) {
		var _p2 = keyCode;
		switch (_p2) {
			case 32:
				return _elm_lang$core$Native_Utils.eq(model.started, false) ? _user$project$Main$Start : _user$project$Main$Stop;
			case 27:
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Native_Utils.eq(model.started, true) ? _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$animation_frame$AnimationFrame$times(_user$project$Main$Tick),
				_elm_lang$keyboard$Keyboard$downs(
				_user$project$Main$onKeyPress(model))
			])) : _elm_lang$keyboard$Keyboard$downs(
		_user$project$Main$onKeyPress(model));
};
var _user$project$Main$view = function (model) {
	...
	var h = _elm_lang$core$Basics$round(
		_elm_lang$core$Basics$toFloat(
			_elm_lang$core$Date$millisecond(diff)) / 10);
	var hundredths = (_elm_lang$core$Native_Utils.cmp(h, 100) < 0) ? h : 0;
	var minutes = _elm_lang$core$Date$minute(diff);
	var seconds = _elm_lang$core$Date$second(diff);
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						{ctor: '_Tuple2', _0: 'Chrono', _1: true},
						{ctor: '_Tuple2', _0: 'started', _1: model.started},
						{
						ctor: '_Tuple2',
						_0: 'stopped',
						_1: _elm_lang$core$Basics$not(model.started) && (_elm_lang$core$Native_Utils.cmp(model.suspended, 0) > 0)
					}
					]))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_user$project$Main$pad(minutes)),
						_elm_lang$html$Html$text(':'),
						_elm_lang$html$Html$text(
						_user$project$Main$pad(seconds)),
						_elm_lang$html$Html$text(':'),
						_elm_lang$html$Html$text(
						_user$project$Main$pad(hundredths))
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
...
var _user$project$Main$app = _elm_lang$html$Html_App$program(
	{init: _user$project$Main$init, update: _user$project$Main$update, view: _user$project$Main$view, subscriptions: _user$project$Main$subscriptions});
var _user$project$Main$main = {main: _user$project$Main$app};
